...
if player[0] == cpu[0]:
    ...
    if player[4] == cpu[4]:
        ...
        if player[8] == cpu[8]:
            ...
            if player[12] < cpu[12]:
                print("defeat {0} < {1}".format(player[12], cpu[12]))
                ...
                for i, v in enumerate(player):
                    ...
                    for i, v in enumerate(cpu):
                        ...
                        del cpu[:12]
            if player[12] > cpu[12]:
                print("victory {0} > {1}".format(player[12], cpu[12]))
            ...
            if player[12] == cpu[12]:
                ...
                if player[16] < cpu[16]:
                    print("defeat {0} < {1}".format(player[16], cpu[16]))
                    ...
                    del cpu[:16]
                if player[16] > cpu[16]:
                    print("victory {0} > {1}".format(player[16], cpu[16]))
                ...
                if player[16] == cpu[16]:
                    ...
                    if player[20] < cpu[20]:
                        print("defeat {0} < {1}".format(player[20], cpu[20]))
                        ...
                        del cpu[:20]
                    if player[20] > cpu[20]:
                        print("victory {0} > {1}".format(player[20], cpu[20]))
                    ...
                    if player[20] == cpu[20]:
                        ...
                        if player[24] < cpu[24]:
                            print("defeat {0} < {1}".format(player[24], cpu[24]))
                            ...
                            del cpu[:24]
                        if player [24] > cpu[24]:
                            print("victory {0} > {1}".format(player[24], cpu[24]))
                        ...
                        if player[24] == cpu[24]:
                            ...
                            if player[26] < cpu[26]:
                                print("defeat {0} < {1}".format(player[26], cpu[26]))
                                ...
                                del cpu[:26]
                            if player[26] > cpu[26]:
                                print("victory {0} > {1}".format(player[26], cpu[26]))
